...
private JTextField studentIDField;
	...
	public AddAStudent() {
		...
		springLayout.putConstraint(SpringLayout.WEST, sessionField, 0, SpringLayout.WEST, studentIDField);
		...
		springLayout.putConstraint(SpringLayout.WEST, sessionBox, 426, SpringLayout.WEST, getContentPane());
		springLayout.putConstraint(SpringLayout.EAST, sessionField, -6, SpringLayout.WEST, sessionBox);
		springLayout.putConstraint(SpringLayout.NORTH, sessionBox, -3, SpringLayout.NORTH, lblSessionRequestedoption);
		...
		springLayout.putConstraint(SpringLayout.NORTH, programBox, 0, SpringLayout.NORTH, lblProgramRequestedoption);
		springLayout.putConstraint(SpringLayout.WEST, programBox, 0, SpringLayout.WEST, sessionBox);
