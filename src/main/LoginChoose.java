...
public class LoginChoose extends JFrame{
	...
	public LoginChoose() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if(!username.equals("")&& !password.equals("") && rdbtnAdministrator.isSelected()) {
						...
						String sql ="Select * from student_accessible Where username='" + username + "' and password='" + password + "'";
						PreparedStatement statement = conn.prepareStatement(sql);
						ResultSet rs = (ResultSet) statement.executeQuery(sql);
		...
		lblNewStudent.setForeground(SystemColor.textHighlight);
	...
	//	ImageIcon imageLogin= new ImageIcon("C:\\Users\\sunpr\\OneDrive\\Pictures\\LoginImage3.jpg");
		ImageIcon imageLogin= new ImageIcon(getClass().getResource("/image/LoginImage3.jpg"));
